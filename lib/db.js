...
const initialComplaints = [
  { id: "DH123456", pg_id: "3", pg_name: "Dream Homes PG - Civil Lines", room_number: "204", student_name: "Arjun Mehra", student_phone: "+91 9988776655", category: "electrical", categoryIcon: "💡", categoryLabel: "Electrical", priority: "high", status: "assigned", assigned_to: "Ramesh Electrician", assigned_to_phone: "+91 99887 76655", description: "AC in room 204 is not cooling properly since 2 days.", created_at: "2024-07-10T10:30:00", updated_at: "2024-07-11T09:00:00" },
...
export async function getAdminDashboardData() {
  ...
  try {
    ...
    // Merge any locally stored complaints if present
    const localComplaints = getComplaintsList();
    const existingIds = new Set(complaints.map(c => c.id));
    for (const lc of localComplaints) {
